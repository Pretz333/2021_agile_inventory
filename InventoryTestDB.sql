CREATE DATABASE  IF NOT EXISTS `inventory_test` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `inventory_test`;
...
CREATE TABLE `inventory` (
  ...
  `ExpectedCount` int unsigned DEFAULT NULL,
  `ActualCount` int unsigned DEFAULT NULL,
  `InventoryCompletionDate` datetime DEFAULT NULL,
...
--
-- Dumping routines for database 'inventory_test'
--
...
-- Dump completed on 2021-02-10 20:37:31
